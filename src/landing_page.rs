...
pub fn render_page(view: &LandingPageView) -> String {
    ...
    format!(
        r#"<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Diviner Awards · Divine</title><meta name="description" content="Badges for the loudest humans on Divine. No algorithm picks. No vibes check. Just loops."><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,500;12..96,700;12..96,800&family=Inter:wght@400;500;600;700&display=swap"><style>{css}</style></head><body><div class="splat splat--green"></div><div class="splat splat--pink"></div><div class="splat splat--yellow"></div><main class="shell"><nav class="topbar"><a class="brand" href="https://divine.video"><span class="logomark" aria-hidden="true"></span><span>Divine</span></a><span class="status"><span class="dot" aria-hidden="true"></span>Live &middot; updated every UTC morning</span></nav><header class="hero"><p class="eyebrow"><span class="sticker sticker--yellow">No slop. All human.</span></p><h1>Trophies for the loud<span class="punct">.</span></h1><p class="lede">Every closed UTC day, week, and month, we hand a badge to whoever made the most noise on the Divine leaderboard. No algorithm picks. No vibes check. Just loops. This page is the receipt.</p><div class="hero-meta"><span>Signed on <b>relay.divine.video</b></span><span>Compiled at <b>Cloudflare&rsquo;s edge</b></span><span>Stored in <b>D1</b></span></div></header>{sections}<section class="howto"><p class="eyebrow eyebrow--mint">How it works</p><h2>A small worker. A big loudspeaker.</h2><ol><li><span class="n">1</span><p>A Rust worker wakes up at 00:05 UTC, reads the Divine creator leaderboard, and closes the most recent day &mdash; plus the week or month whenever the calendar says so.</p></li><li><span class="n">2</span><p>It filters out anyone who hasn&rsquo;t posted a video in 30 days, so archive profiles don&rsquo;t hoard the spotlight.</p></li><li><span class="n">3</span><p>The worker signs a NIP&#8209;58 badge award with a Schnorr key, broadcasts it on the Divine relay, and yells about it in Discord.</p></li></ol></section><footer class="foot"><p>Built at <a href="https://divine.video">divine.video</a>. Open source. Own what you make. Life in loops.</p><nav><a href="/healthz">health</a><a href="https://github.com/rabble/divine-badges">source</a><a href="https://divine.video">divine.video</a></nav></footer></main></body></html>"#,
        css = page_css()
    )
}
